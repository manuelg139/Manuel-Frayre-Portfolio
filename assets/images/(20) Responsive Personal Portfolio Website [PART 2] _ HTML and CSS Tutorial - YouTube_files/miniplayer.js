...
fill:"#fff","fill-rule":"nonzero"}}]}]}]},e="Expand");g.X.call(this,{D:"button",ka:["ytp-miniplayer-expand-watch-page-button","ytp-button",c],U:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button"},S:[d]});this.G=a;this.ya("click",this.onClick,this);this.Aa("title",g.gO(a,e,"i"));g.Ri(this,g.EO(b.Nb(),this.element))},t4=function(a){g.X.call(this,{D:"div",
...
this.yi);this.yi.fa(this.zj.element);this.Yc=new g.eQ(this.player,this);g.J(this,this.Yc);g.AN(this.player,this.Yc.element,4);this.yu=new g.X({D:"div",K:"ytp-miniplayer-buttons"});g.J(this,this.yu);g.AN(this.player,this.yu.element,4);a=new g.X({D:"button",ka:["ytp-miniplayer-close-button","ytp-button"],U:{"aria-label":"Close"},S:[g.AL()]});g.J(this,a);a.fa(this.yu.element);this.N(a.element,"click",this.oj);a=new g.X({D:"button",ka:["ytp-miniplayer-replay-button","ytp-button"],U:{"aria-label":"Close"},
